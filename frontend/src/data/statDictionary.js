...
export const statDictionary = {
  ...
  avg_velo: {
    realName: 'Velocity',
    simpleName: 'Velo',
    fullName: 'Average Release Velocity',
    shortExplain: 'The pitcher’s average pitch speed in a start, in mph.',
    extraExplain: 'Higher velocity generally makes pitches harder to hit, especially when paired with movement.',
    goodDirection: 'high',
    scale: { poor: 88, average: 92, great: 95 },
    format: 'mph',
    group: 'pitching',
  },
  whiff_pct: {
    ...
    simpleName: 'Whiff%',
    fullName: 'Whiff Rate',
    shortExplain: 'The share of swings that miss the pitcher’s pitches.',
    extraExplain: 'A higher whiff rate means the pitcher is generating more swings and misses, which is a strong outcome. ',
    goodDirection: 'high',
    scale: { poor: 18, average: 23, great: 28 },
    format: 'percent',
    group: 'pitching',
  },
  era: {
  ...
  pitch_count: {
    realName: 'P',
    simpleName: 'P',
    fullName: 'Pitch Count',
    shortExplain: 'The number of pitches thrown in the start.',
    extraExplain: 'Pitch count is useful for finding efficient outings and workload issues. ',
    goodDirection: 'low',
    scale: { poor: 120, average: 95, great: 70 },
    format: 'integer',
    group: 'pitching',
  },
  k_pct: {
