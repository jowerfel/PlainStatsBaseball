...
export const statDictionary = {
  ...
  war: {
    ...
    shortExplain: 'A site-specific batting WAR estimate: (1B×0.44 + 2B×0.74 + 3B×1.04 + HR×1.4 + SO×(-0.3) + BB×0.29 + SB×0.2 + HBP×0.31) ÷ 10.',
    extraExplain: "This is PlainStats' own formula, not a published sabermetric source (MLB's own API doesn't publish WAR at all) — treat it as this site's house stat, not an official number. Weights live in backend/jwinsFormula.js.",
    goodDirection: 'high',
  ...
  war_pitching: {
    ...
    shortExplain: 'A site-specific pitching WAR estimate: ((H-HR)×(-0.55) + HR×(-1.4) + SO×0.3 + BB×(-0.29) + IP×0.6) ÷ 10.',
    extraExplain: "This is PlainStats' own formula, not a published sabermetric source (MLB's own API doesn't publish WAR at all) — treat it as this site's house stat, not an official number. Weights live in backend/jwinsFormula.js.",
    goodDirection: 'high',
  ...
  war_fielding: {
    ...
    shortExplain: 'A site-specific fielding WAR estimate, calculated differently by position — most positions use (PutOuts + Assists − Errors); first base and catcher exclude putouts (which mostly just reflect receiving routine throws or strikeouts, not fielding skill) in favor of assists and, for catchers, caught stealing / passed balls / double plays.',
    extraExplain: "This is PlainStats' own formula, not a published sabermetric source, redesigned to stop overrating first basemen and catchers — a known issue with raw putouts at those two positions (see e.g. SABR's writeup on Fielding Runs). See backend/jwinsFormula.js for the exact by-position formula and weights, and to change them.",
    goodDirection: 'high',
