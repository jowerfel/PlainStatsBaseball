...
export const statDictionary = {
  ...
  war_fielding: {
    ...
    shortExplain: 'A site-specific fielding WAR estimate: (((PutOuts + Assists - Errors) × 0.2) + a positional run-value adjustment) ÷ 10.',
    extraExplain: "This is PlainStats' own formula, not a published sabermetric source. The positional adjustment reflects that some positions (catcher, shortstop) are inherently more defensively demanding than others (first base, DH) — see backend/jwinsFormula.js for the exact by-position values and to change them.",
    goodDirection: 'high',
