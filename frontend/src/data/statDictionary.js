...
export const statDictionary = {
  ...
  war: {
    realName: 'JWar',
    simpleName: 'JWar',
    fullName: 'JWar (custom Wins Above Replacement)',
    shortExplain: 'A site-specific WAR estimate: 1B×0.44 + 2B×0.74 + 3B×1.04 + HR×1.4 + SO×(-0.3) + BB×0.29 + SB×0.2 + HBP×0.31.',
  ...
  war_pitching: {
    realName: 'JWar',
    simpleName: 'JWar',
    fullName: 'JWar (custom Pitching Wins Above Replacement)',
    shortExplain: 'A site-specific pitching WAR estimate: (H-HR)×(-0.55) + HR×(-1.4) + SO×0.3 + BB×(-0.29) + IP×0.6.',
    extraExplain: "This is PlainStats' own formula, not a published sabermetric source (MLB's own API doesn't publish WAR at all) — treat it as this site's house stat, not an official number.",
    goodDirection: 'high',
