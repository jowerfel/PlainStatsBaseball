...
export const statDictionary = {
  ...
  war: {
    realName: 'JWins',
    simpleName: 'JWins',
    fullName: 'JWins (custom Wins Above Replacement)',
    shortExplain: 'A site-specific WAR estimate: (1B×0.44 + 2B×0.74 + 3B×1.04 + HR×1.4 + SO×(-0.3) + BB×0.29 + SB×0.2 + HBP×0.31) ÷ 10.',
  ...
  war_pitching: {
    realName: 'JWins',
    simpleName: 'JWins',
    fullName: 'JWins (custom Pitching Wins Above Replacement)',
